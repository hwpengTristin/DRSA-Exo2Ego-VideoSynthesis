...
Our dataset includes 819 exo-ego video pairs, totaling approximately 10.8 hours of episodes (totaling 2,328,054 frames). Some examples of scenarios and interacting objects from the Dynamic Scenes and interacting Objects Exo-Ego (DSO ExoEgo) dataset. Zoom in for details.
